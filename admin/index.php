		...
		<div class="main" style="max-width:380px">
			...
			<div class="contents">
				...
				<form method="post" id="logform">
					<p><i class="fa fa-user-o" style="font-size:21px;margin-right:5px"></i> <input type="text" placeholder="Username" name="usern" id="usern" onkeyup="checkkeys(event)" autocomplete="off"></p><br><br>
