...
set_include_path('/Users/amoskipkorir/Downloads/chemelil sugarcane/admin/photos');
...
if (isset($_POST['ptp'])) {
	...
	if (isset($_GET['pcode'])) {
		...
		if (is_numeric($res)) {
			echo "Error: Code validation requires internet connection";
		} else {
