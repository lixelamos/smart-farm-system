			...
			<div style="height:85%;overflow:auto;width:100%;margin:0 auto">
				<div style="padding:20px">
					<table cellpadding="5" cellspacing="5" class="tbl">
						<tr>
							<td onclick="window.location=window.location"><i class="fa fa-home" style="font-size:23px"></i><br>Home</td>
							...
							<td onclick="loadpage('agacc')"><i class="fa fa-user-o" style="font-size:23px"></i><br>Account</td>
						</tr>
					</table><br>
